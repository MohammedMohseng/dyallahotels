                  ...
                  <SelectContent>
                    {availableRooms.map((room) => (
                      <SelectItem key={room.id} value={room.id}>
                        {room.roomNumber} -{" "}
                        {ROOM_TYPE_MAP[room.type] || room.type} (الطابق{" "}
                        {room.floor}) - {formatCurrency(room.pricePerNight)}
                        /ليلة
                      </SelectItem>
                    ))}
                  </SelectContent>
                    ...
                    <TableRow key={reservation.id}>
                      ...
                      <TableCell>
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">
                            {ROOM_TYPE_MAP[reservation.room.type] ||
                      ...
                      <TableCell>
                        <Badge
                          variant={
                            STATUS_BADGE_MAP[reservation.status] || "secondary"
                          }
                        >
